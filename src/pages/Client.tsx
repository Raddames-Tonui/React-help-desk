...
const schema = yup.object().shape({
  mainCategory: yup.string().trim().required("Main Category is required"),
  subCategory: yup.string().trim().required("Sub Category is required"),
  problem: yup.string().trim().required("Problem/Issue is required"),
  ...
  files: yup
    ...
    .of(
      yup
        ...
        .test("fileType", "Only JPG, JPEG, PNG, or PDF allowed", (file) =>
          file
  ...
  return (
    <section>
        ...
        <form className="form" id="ticket-form" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({ type: "SET_FIELD", field: "mainCategory", value: e.target.value })
              }
            />
            {errors.mainCategory && <p className="error">{errors.mainCategory}</p>}
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({ type: "SET_FIELD", field: "subCategory", value: e.target.value })
              }
            />
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={state.problem}
              onChange={(e) =>
                dispatch({ type: "SET_FIELD", field: "problem", value: e.target.value })
              }
            />
          ...
          <div className="form-group">
            ...
            <Editor
              ...
              onChange={(html) =>
                dispatch({ type: "SET_FIELD", field: "description", value: html })
              }
            />
      ...
      <div className="form-actions">
        ...
        <button type="button" className="cancel" onClick={() => dispatch({ type: "RESET" })}>
          Cancel
        </button>
      </div>
    </section>
